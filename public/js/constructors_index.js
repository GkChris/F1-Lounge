    ...
    delayTimer = setTimeout(function() {
        ...
        xhr.onload = function () {
            ...
            for (let i = 0; i < json.length; i++) {
                document.getElementById('result_box').innerHTML += '<a href="/constructors/'+json[i].constructorRef+'"><strong>'+json[i].name+'</strong> ('+json[i].nationality+')</a></br>';
            }
