...
<script src="{{ asset('js/circuits_index.js') }}" defer></script>
<link href="{{ asset('/css/circuits_index.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="container" onclick="closeSearch();">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page_info d-flex flex-column text-center">
                    ...
                    <h4>{{ count($allCircuits) }} circuits from {{ $allCircuitsDistinctCountries }} countries</h4>
                    <h5>Present active and historical F1 circuits since 1950</h5>
                </div>
            </div>
        </div>
        ...
        <div class="container_box_content d-flex justify-content-center">
            <div class="container_box_box">
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="season_rounds">
                            <a href="/seasons"><p class="border rounded">Search circuits by season</p></a> 
                            <i>Select season -> Rounds</i>
                            <a href="/2021"><p class="border rounded">See active circuits</p></a> 
                            <i>Go to Rounds </i>
                        </div>
                    </div>
                    <div class="col-xl-7">
                ...
                <div class="row">
                    @include('layouts.circuits_index.country_sort')
                </div>
