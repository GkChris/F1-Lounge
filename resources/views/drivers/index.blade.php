...
<script src="{{ asset('js/drivers_index.js') }}" defer></script>
<link href="{{ asset('/css/drivers_index.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="row">
            <div class="col-12">
                <div class="page_info d-flex flex-column text-center">
                    ...
                    <h4>{{ count($allDrivers) }} drivers from {{ $allDriversDistinctCountries }} countries</h4>
                    <h5>All F1 drivers since 1950</h5>
                </div>
            </div>
        </div>
        ...
        <div class="container_box_content d-flex justify-content-center">
            <div class="container_box_box">
                ...
                <div class="row">
                    <div class="col-xl-5">
                        <div class="season_rounds">
                           <a href="/seasons"><p class="border rounded">Search drivers by season</p></a> 
                           <i>Select season -> Participants -> Drivers</i>
                           <a href="/2021"><p class="border rounded">See active drivers</p></a> 
                           <i>Go to Participants -> Drivers</i>
                        </div>
                    </div>
                    <div class="col-xl-7">
                ...
                <div class="row" id="index_content">
                    @include('layouts.drivers_index.country_sort')
                </div>
